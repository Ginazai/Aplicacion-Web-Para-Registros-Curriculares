$(document).ready(function() {
	$('#addEdu').click(function(e) {
		...
		if (j >= 9) {
			...
			if (j < 9) {
				var check = $('edu_field').children().children();
				($('edu_field') != undefined) ? console.log(check.attr('id')) : console.log('it does not exist');
				
				($('.edu_field').attr('id') == 'edu_year' + j) ? console.log('edu_year' + j + 'exists') : $('#edu_fields').append('<div class="edu_field row">\
